...
app.use(cors({
  origin: ['http://127.0.0.1:5500', 'http://localhost:5500','https://www.auravestfinedge.com','https://auravestfinedge.com','http://localhost:3000','https://auravest-admin.vercel.app'], // allow both to avoid IP/host mismatch pain
  credentials: true,
